...
<body>
  		...
  		<div class="modal-dialog" role="document">
    			<div class="modal-content">
      				...
      				<div class="modal-body">
        				<p>Do you wish to confirm the update of your account details?</p>
      				</div>
    ...
    <div class="main-banner" id="top">
		...
		<div class="alert alert-success" role="alert">
  			To update your profile picture, update your photo on your google account, <a href="" class="alert-link">reload</a> this page, and hit update!
		</div>
                <h6></h6>
                <h2> <em>Edit Profile</em> </h2>
                    		  <center>
				  <div class="textbox">
				  ...
				  <center>
					...
					<div>
				        <input type="button" class="createAcct_btn" id="submitBtn" value="UPDATE">
					</div>
				  </center>
          <h1>	
          </h1>
    ...
    <script src="updateAcc.js"></script>
